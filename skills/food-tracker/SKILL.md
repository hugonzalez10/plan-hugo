...
description: >
  ...
  fotos o texto: estima calorías/macros/composición con visión IA y escribe un JSON
  en Google Drive (plan-hugo-bridge.json) que la app "Plan Hugo" consume directo.
  USAR SIEMPRE que Hugo mande una foto de comida, una captura de báscula/composición
  (peso, % grasa, músculo) o de entrenamiento (Apple Fitness, Strava, etc.), o diga
  "comí X", "registra/anota esto", "cuántas calorías tiene", "pésame esto", "registra
  mi peso", "anota este entrenamiento/ejercicio", "registra/agrega/añade/suma X de
  agua", "tomé X vasos", "me tomé una botella/litro", o cualquier variación de
  registro de comida, peso, actividad o agua. agregar/añadir/sumar = registrar
  (ej. "agrega 1.5lt de agua" = 1500 ml). También con "cómo voy hoy", "cuánto llevo",
  "resumen del día".
---
